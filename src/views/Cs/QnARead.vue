        ...
        <div class="w-[1000px]">
            <div class="flex justify-between mb-10">
                ...
                <div class="flex gap-x-5">
                    <router-link to="/cs/qna/list" class="bg-[#a6acb9] text-black hover:bg-[#20293C] duration-200 py-2 px-4 hover:text-white font-semibold rounded shadow-md text-xs sm:text-sm mt-5">목록</router-link>
                </div>
                <!-- 상단 - 오른쪽 영역 -->
                <div v-if="$store.state.loginToken != null" class="flex gap-x-5">
                    <router-link to="/cs/qna/modify" class="bg-[#a6acb9] text-black hover:bg-[#20293C] duration-200 py-2 px-4 hover:text-white font-semibold rounded shadow-md text-xs sm:text-sm mt-5">수정</router-link>
